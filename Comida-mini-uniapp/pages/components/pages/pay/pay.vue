    ...
    <view style="margin-bottom: 130rpx">
      <view class="section-1">
        ...
        <template v-if="orderType == 'takein'">
          <list-cell @click="scanQRcode">
            <view
              class="flex-fill d-flex justify-content-between align-items-center"
            >
              <!-- <view class="store-name flex-fill">桌台</view>
              <view>请扫描桌台码</view>
              <image src="/static/images/scan.png" class="arrow"></image> -->
            </view>
          </list-cell>
        </template>
        ...
        <template v-if="orderType == 'takeout'">
          <list-cell @click="chooseAddress">
            ...
            <view
              ...
              class="flex-fill d-flex justify-content-between align-items-center"
            >
              <view class="store-name flex-fill">选择配送地址</view>
