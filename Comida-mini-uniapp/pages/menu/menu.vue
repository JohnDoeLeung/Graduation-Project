			...
			<view class="main">
				...
				<view class="content"
					...
					<view class="content"
						:style="{ height: 'calc(100vh - 500rpx + ' + (store.notice ? '0rpx' : '60rpx') + ')' }">
						<!-- #endif -->
						<scroll-view class="menus" :scroll-into-view="menuScrollIntoView" scroll-with-animation
							scroll-y>
							<view class="wrapper">
					...
					<scroll-view class="detail" scroll-y>
						...
						<view class="wrapper">
							<view class="basic">
								...
								<view class="tips flex justify-between">{{ good.storeInfo }} <text
										style="color: red;">可获积分:10</text></view>
							</view>
	...
	if (!location.value.hasOwnProperty("latitude")) {
		...
		uni.getLocation({
			...
			fail: function (res) {
				...
				// 默认为长春的地址
				result = {
					latitude: 43.8632982816377,
					longitude: 125.28588824541,
				};
				getShopList(result);
			},
