...
import static org.comida.framework.common.util.collection.CollectionUtils.filterList;
...
public interface AuthConvert {
    ...
    default AuthPermissionInfoRespVO convert(AdminUserDO user,List<MenuDO> menuList) {
