...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setBucket("comida-aoteman");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("comida-pro");
        config.setDomain("http://test.comida.yixiang.co"); // 如果有自定义域名，则可以设置。http://static.comida.yixiang.co
        // 默认上海的 endpoint
