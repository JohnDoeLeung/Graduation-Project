...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "co.comida.boot";
    private static final String ARTIFACT_ID = "comida";
    private static final String PACKAGE_NAME = "org.comida";
    private static final String TITLE = "餐饮管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "co.comida.boot";
        String artifactIdNew = "comida";
        String packageNameNew = "org.comida";
        String titleNew = "餐饮管理系统";
