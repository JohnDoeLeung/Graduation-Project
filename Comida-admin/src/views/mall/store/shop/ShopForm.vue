    ...
    >
      ...
      <el-form-item label="外卖配送距离/千米" prop="distance">
        <el-input
          ...
          placeholder="请输入外卖配送距离,单位为千米。0表示不送外卖"
        />
      </el-form-item>
      ...
      <el-form-item label="绑定管理员" prop="adminId">
        <el-select v-model="formData.adminId" multiple placeholder="选择用户">
          <el-option
...
const formRules = reactive({
  ...
  distance: [
    { required: true, message: '外卖配送距离,单位为千米。0表示不送外卖不能为空', trigger: 'blur' }
  ],
