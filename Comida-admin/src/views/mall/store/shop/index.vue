<template>
  <ContentWrap>
    ...
    <el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
      ...
      <el-form-item label="店铺电话" prop="mobile">
        <el-input v-model="queryParams.mobile" placeholder="请输入店铺电话" clearable @keyup.enter="handleQuery"
          class="!w-240px" />
      </el-form-item>
      <el-form-item>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="营业开始时间" align="center" prop="startTime" :formatter="dateFormatter2" width="150" />
      <el-table-column label="营业结束时间" align="center" prop="endTime" :formatter="dateFormatter2" width="150" />
      <el-table-column label="添加时间" align="center" prop="createTime" :formatter="dateFormatter" width="170" />
